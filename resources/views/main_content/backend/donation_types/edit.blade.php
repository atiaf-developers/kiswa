...
<li><span> {{_lang('app.edit_donation_types')}}</span></li>
@endsection
...
<form role="form"  id="addEditDonationTypesForm" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <input type="hidden" name="id" id="id" value="{{ $donation_type->id }}">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-3">
                    <input type="number" class="form-control" id="this_order" name="this_order" value="{{ $donation_type->this_order }}">
                ...
                <div class="form-group form-md-line-input col-md-2">
                    <select class="form-control edited" id="active" name="active">
                        <option {{ $donation_type->active == 1 ? 'selected' : '' }} value="1">{{ _lang('app.active') }}</option>
                        <option {{ $donation_type->active == 0 ? 'selected' : '' }} value="0">{{ _lang('app.not_active') }}</option>
                    </select>
