...
<div class="modal fade" id="addEditWorker" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditWorkerLabel"></h4>
            </div>

            <div class="modal-body">


                <form role="form"  id="addEditWorkerForm"  enctype="multipart/form-data">
                    {{ csrf_field() }}
...
<script>
    var new_lang = {
        'add_worker': "{{_lang('app.add_worker')}}",
        'edit_worker': "{{_lang('app.edit_worker')}}",
        messages: {
            username: {
